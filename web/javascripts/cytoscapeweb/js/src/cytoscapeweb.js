...
(function () {
     ...
     * error.title = Error
     * pan.agenttip = Grab to pan
     * pan.up.agenttip = Pan up
     * pan.down.agenttip = Pan down
     * pan.left.agenttip = Pan left
     * pan.right.agenttip = Pan right
     * zoom.out.agenttip = Zoom out
     * zoom.in.agenttip = Zoom in
     * zoom.fit.agenttip = Fit to screen
     * zoom.slider.agenttip = {0}%
     * </pre></li>
    ...
    org.cytoscapeweb.Visualization.prototype = {
         ...
         *                    <li><code>nodeAgenttipsEnabled</code>: Boolean value that enables or disables the node agenttips.
         *                                                          The default value is <code>true</code>.
         *                                                          You can call {@link org.cytoscapeweb.Visualization#nodeAgenttipsEnabled} later to change it.</li>
         *                    <li><code>edgeAgenttipsEnabled</code>: Boolean that enables or disables the edge agenttips.
         *                                                          The default value is <code>true</code>.
         *                                                          You can use {@link org.cytoscapeweb.Visualization#edgeAgenttipsEnabled} later to change it.</li>
        ...
        /**
         * <p>If the boolean argument is passed, it enables or disables the node agenttips.</p>
         * <p>If not, it returns a boolean value indicating whether or not the node agenttips are enabled.</p>
         * @param {Boolean} [enabled] true to enable the agenttips or false to disable them.
         * @return <ul><li>A boolean value for <code>nodeAgenttipsEnabled()</code>.</li>
         *             <li>The {@link org.cytoscapeweb.Visualization} object for <code>nodeAgenttipsEnabled({Boolean})</code>.</li></ul>
         */
        nodeAgenttipsEnabled: function (/*enabled*/) {
            var swf = this.swf();
            if (arguments.length > 0) { swf.enableNodeAgenttips(arguments[0]); return this; }
            else { return swf.isNodeAgenttipsEnabled(); }
        },

        /**
         * <p>If the boolean argument is passed, it enables or disables the edge agenttips.</p>
         * <p>If not, it returns a boolean value indicating whether or not the edge agenttips are enabled.</p>
         * @param {Boolean} [enabled] true to enable the agenttips or false to disable them.
         * @return <ul><li>A boolean value for <code>edgeAgenttipsEnabled()</code>.</li>
         *             <li>The {@link org.cytoscapeweb.Visualization} object for <code>edgeAgenttipsEnabled({Boolean})</code>.</li></ul>
         */
        edgeAgenttipsEnabled: function (/*enabled*/) {
            var swf = this.swf();
            if (arguments.length > 0) { swf.enableEdgeAgenttips(arguments[0]); return this; }
            else { return swf.isEdgeAgenttipsEnabled(); }
        },
     ...
     *                                         maxValue: 36 } },
     *             borderColor: "#000000",
     *             agenttipText: "&lt;b&gt;&#36{label}&lt;/b&gt;: &#36{weight}"
     *         },
     *         edges: {
     *             color: "#999999",
     *             width: 2,
     ...
     *     <li><code>agenttipDelay</code>  {Number}: Number of milliseconds to delay before displaying the agenttip, when the cursor is over a node or edge.
     ...
     *     <li><code>agenttipText</code> {String}: Static text or a text formatter for node agent tips. 
     *                                                             A list with all the node <code>data</code> attributes is displayed by default.</li>
     *     <li><code>agenttipFont</code> {String}: Font name of node agent tips. The default font is "Arial".</li>
     *     <li><code>agenttipFontSize</code> {Number}: The point size of node agent tips. The default value is 11.</li>
     *     <li><code>agenttipFontColor</code> {String}: Font color of node agent tips. The default value is "#000000".</li>
     *     <li><code>agenttipBackgroundColor</code> {String}: Background color of node agent tips. The default value is "#f5f5cc".</li>
     *     <li><code>agenttipBorderColor</code> {String}: Border color of node agent tips. The default value is "#000000".</li></ul>
     * @property
     * @name nodes
     * @type Object
     * @memberOf org.cytoscapeweb.VisualStyle#
     ...
     *                                                                   is imprinted and the stronger the contrast between the glow and the background.
     *                                                                   Valid values are 0 to 255. The default is 20.</li>
     *     <li><code>agenttipText</code> {String}: Static text or a text formatter for regular edge agent tips. 
     *                                                             A list with all the edge <code>data</code> attributes is displayed by default.</li>
     *     <li><code>mergeAgenttipText</code> {String}: Static text or a text formatter for merged edge agent tips.
     *                                                                  A list with all the merged edge <code>data</code> attributes is displayed by default.</li>
     *     <li><code>agenttipFont</code> {String}: Font name of edge agent tips. The default font is "Arial".</li>
     *     <li><code>agenttipFontSize</code> {Number}: The point size of edge agent tips. The default value is 11.</li>
     *     <li><code>agenttipFontColor</code> {String}: Font color of edge agent tips. The default value is "#000000".</li>
     *     <li><code>agenttipBackgroundColor</code> {String}: Background color of edge agent tips. The default value is "#f5f5cc".</li>
     *     <li><code>agenttipBorderColor</code> {String}: Border color of edge agent tips. The default value is "#000000".</li></ul>
     * @property
     * @name edges
     * @type Object
     * @memberOf org.cytoscapeweb.VisualStyle#
     ...
     * <p>You could, for example, use a custom mapper to create a better agenttip text.</p>
     * 
     * @example
     * // 1. First, create a function and add it to the Visualization object.
     * vis["customAgenttip"] = function (data) {
     ...
     * style.edges.agenttipText = { customMapper: { functionName: "customAgenttip" } },
     * 
