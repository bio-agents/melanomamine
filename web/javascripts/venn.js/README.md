...
Another common case is adding a agenttip when hovering over the elements in the diagram. The only
...
// add listeners to all the groups to display agenttip on mouseover
div.selectAll("g")
    .on("mouseover", function(d, i) {
...
```
[View this example](http://benfred.github.io/venn.js/examples/intersection_agenttip.html)
